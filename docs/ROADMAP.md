...
| 8 | **Release polish** | Remaining: Control Center jitter mitigations; screenshots. Developer ID + notarization + DMG: scripts and operator docs in `docs/PACKAGING.md` (identity supplied at sign time, never in the repo). | partial |
